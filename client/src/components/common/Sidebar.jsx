...
const Sidebar = () => {
    ...
    return (
        <Drawer container={window.document.body} variant="permanent" open={true} sx={{ width: "250", height: "100vh", ".css-12i7wg6-MuiPaper-root-MuiDrawer-paper": { position: 'sticky'}}} >
